...
CREATE DATABASE IF NOT EXISTS pubs CHARACTER SET LATIN1 
...
CREATE TABLE IF NOT EXISTS pub (
  ...
  CONSTRAINT fk_pub_localidad_codlocalidad
...
CREATE TABLE IF NOT EXISTS titular (
  ...
  CONSTRAINT fk_titular_pub_codpub
...
CREATE TABLE IF NOT EXISTS existencias (
  ...
  cod_pub SMALLINT UNSIGNED NOT NULL,
  CONSTRAINT fk_existencias_pub_codpub
  FOREIGN KEY (cod_pub) REFERENCES pub(cod_pub)
);
...
CREATE TABLE IF NOT EXISTS pub_empleado (
  ...
  CONSTRAINT fk_pubempleado_pub_codpub
  FOREIGN KEY (cod_pub) REFERENCES pub(cod_pub),
  CONSTRAINT fk_pubempleado_empleado_dniempleado
