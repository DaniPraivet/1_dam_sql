...
SELECT c.id FROM pedido p, cliente c INNER JOIN cliente ON pedido.id_cliente = c.id; 
...
-- 9. Devuelve un listado de los nombres de los clientes que no empiezan
-- por A. El listado deberá estar ordenado alfabéticamente.
